  ...
  return (
    <ThunderCard>
      ...
      <Image
        ...
        width={800}
        height={1200}
        className="w-115 h-auto object-cover translate-x-3 relative opacity-99"
      />
      <div className="absolute top-[28%] right-[36%] size-27 lg:size-35 rounded-full bg-white flex items-center justify-center z-10 shadow-2xl">
      ...
      <div className="flex justify-center pt-27 px-10">
        <div className="px-18  bg-[#FFFFFF]/40 rounded-2xl border border-white opacity-99">
          <div className="flex justify-between">
            <p className="p-5 text-[20px] text-[#323232]">Add Note</p>
            <span className="p-2">
